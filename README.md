...
local function KickLocalPlayer(message)
	...
	ErrorMessage.Text = message or "Você foi removido pela enquipe Hit hub. (Código de erro: 134)"
...
local Window = Libary:MakeWindow({
    Title = "🌌 Hit Hub + 🌌 - Nytherune Developers Brookhaven",
    SubTitle = "by: Nytherune Developers (Lcc 027, bmz zx7, )",
    LoadText = "Hit hub Developers",
    Flags = "Hit Hub_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://108965426753071", BackgroundTransparency = 0 },
...
InfoTab:AddDiscordInvite({
    Name = "Hithub Developers",
    Description = "Join server",
    Logo = "rbxassetid://108965426753071",
    Invite = "https://discord.gg/rgEd8bjFS",
})
InfoTab:AddSection({ "Informações do Script" })
InfoTab:AddParagraph({ "Wx (Discord: @bmz_zx7, Lcc_027)" })
InfoTab:AddParagraph({ "Colaborações:", "enquipe Hit hub, enquipe Lcc hub" })
InfoTab:AddParagraph({ "Você está usando:", "Hit Hub" })
InfoTab:AddParagraph({"obrigadopor usar Hit hub!"})
...
sky.SkyboxBk = "rbxassetid://108965426753071"
...
TrollTab:AddButton({
    Name = "[🌌🚀] Expansão de Domínio (by bmz zx7 and Shelby)",
...
TrollTab:AddTextBox({
    ...
    PlaceholderText = "Exemplo: bmz = bmz zx7",
...
TrollTab:AddButton({
    ...
    Description = "Isso é melhor quando usado em cities, confia no bmz!",
    Callback = function()
...
TrollTab:AddButton({
    ...
    Callback = function()
        ...
        if not success then
            ...
            print("[Hit Hub] Tornado finalizado e veículos deletados.")
        end
    end
})
